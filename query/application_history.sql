...
select
  ...
  l.regno,
	l.phone,
  r.okopf_name,
	r.[location_address-region_name],
	r.[location_address-city_name],
	r.[location_address-city_type],
	r.[registration_address-region_name],
	r.[registration_address-region_type],
	r.[registration_address-city_name],
	r.[registration_address-city_type],
	r.city_name,
	r.[activity_classifier_0-name],
	r.service_set,
	r.branch_name,
	r.office_name,
	r.[bank_service_0-name],
	r.[bank_service_1-name],
	r.staff_number
from
	enrich_statuses l
left join
