...
rem C:\ProgramData\Anaconda3\python.exe etl.py --from test_source2 --to temp_table --mode multi
C:\ProgramData\Anaconda3\python.exe etl.py --from test_json --to json_test --mode row-by-row
